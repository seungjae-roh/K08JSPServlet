...
/* 
	...
	Object를 기반으로 저장되므로 차후 값을 읽을 때는 해당 타입으로
	형변환해야 한다.
*/
%>
<html>
...
<body>
	...
	%>
	<ul>
		<!-- Java의 기본클래스인 경우 별도의 처리 없이 즉시 내용을 출력할 수 있다. -->
	...
	포함시킨 후 컴파일을 진행한다. 따라서 동일한 페이지로 취급되므로 page영역이
	그대로 공유된다. 즉, include된 페이지의 내용은 정상적으로 출력된다.
	-->
