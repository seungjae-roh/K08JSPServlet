...
<c:choose>
	...
	<!-- 게시물이 있을 때 컬렉션에 저장된 목록의 갯수만큼 반복한다. -->
		...
		<!-- 
		가상번호 계산하기
		=> 전체 게시물 갯수 - (((페이지번호 - 1) * 페이지당 게시물 수) + 해당루프의 index)
		참고로 varStatus 속성의 index는 0부터 시작한다.
		
			전체 게시물의 갯수가 5개이고 페이지당 2개씩만 출력한다
			1페이지의 첫번쨰 게시물 번호 : 5-(((1-1)*2)+0)=5
			2페이지의 첫번쨰 게시물 번호 : 5-(((2-1)*2)+0)=3
		 -->
	        <tr align="center">
	            <td>
    ...
    <table border="1" width="90%">
        <tr align="center">
            ...
            <td><button type="button" onclick="location.href='../mvcboard/write.do';">
            	글쓰기</button></td>
        </tr>
    </table>
</body>
