...
try {
	...
	*/
	...
	윈도우의 경우\(역슬러시), 리눅스의 경우 /(슬러시)를 자동으로
	부여해준다. File객체를 각각 생성한 후 renameTo()메소드를 통해 변경한다.
	*/
	...
	아닌 mr객체를 통해 받아야 하므로 주의해야 한다. 객체는 다르지만 폼값을 
	받기위한 메소드명은 동일하다.
	*/
	...
	dto.setName(name);
	dto.setTitle(title);
	//입력전 StringBuffer객체를 String을 변환해야 한다.
